...
##save summary
tableone::CreateTableOne(names(dat)[grep("continuous|binary|ordinal|covs_|neuro_|immuno_|anthro_|negcon_|cardio_",names(dat))],factorVars = names(dat)[grep("binary|ordinal",names(dat))],data=dat)->TABLE1
