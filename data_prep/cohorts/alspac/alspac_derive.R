...
dat$covs_occup_mother_highestlowest_binary[dat$covs_occup_mother%in%c(1,2,3)] <- 0
dat$covs_occup_mother_highestlowest_binary[dat$covs_occup_mother==0] <- 1
...
dat$alcohol_father_binge2_binary[dat$pb101==0]<- 0
dat$alcohol_father_binge2_binary[dat$pb101>0]<- 1
