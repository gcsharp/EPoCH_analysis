...
location_of_extra_functions <-"https://github.com/gcsharp/EPoCH_analysis/blob/main/making_key/"
...
## REMOVED PARENT'S DISEASE COVARIATES BECAUSE SMALL N IN PARENT'S DISEASES WAS LIKELY INTRODUCING SELECTION BIAS AND REDUCING POWER
